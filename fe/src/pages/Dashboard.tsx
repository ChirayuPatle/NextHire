...
const Dashboard = () => {
  ...
  // This would be handled better with a protected route component in a real app
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-8">
        ...
        <p className="text-nexthire-text-gray">Manage your recruitment process and track candidates.</p>
      </div>
      
      {/* Stats Overview */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card variant="glass" padding="lg" className="flex items-center">
          <div className="p-3 rounded-full bg-nexthire-purple/20 mr-4">
            <Calendar className="h-6 w-6 text-nexthire-purple" />
          </div>
          <div>
            <p className="text-nexthire-text-gray text-sm">Active Sessions</p>
        ...
        <Card variant="glass" padding="lg" className="flex items-center">
          <div className="p-3 rounded-full bg-nexthire-purple/20 mr-4">
            <Users className="h-6 w-6 text-nexthire-purple" />
          </div>
          <div>
            <p className="text-nexthire-text-gray text-sm">Total Candidates</p>
        ...
        <Card variant="glass" padding="lg" className="flex items-center">
          <div className="p-3 rounded-full bg-nexthire-purple/20 mr-4">
            <CheckCircle className="h-6 w-6 text-nexthire-purple" />
          </div>
          <div>
            <p className="text-nexthire-text-gray text-sm">Tests Completed</p>
        ...
        <Card variant="glass" padding="lg" className="flex items-center">
          <div className="p-3 rounded-full bg-nexthire-purple/20 mr-4">
            <Clock className="h-6 w-6 text-nexthire-purple" />
          </div>
          <div>
            <p className="text-nexthire-text-gray text-sm">Pending Interviews</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {sessions
                ...
                <Card key={session.id} isHoverable className="transition-all duration-300">
                  <div className="flex flex-col md:flex-row justify-between">
                    <div>
                      ...
                      <div className="flex items-center text-nexthire-text-gray text-sm mb-4">
                    ...
                    <div className="flex md:flex-col items-center md:items-end justify-between">
                      <div className="flex items-center md:mb-3">
                        ...
                        <span className="text-nexthire-text-gray text-sm">
              ...
              {sessions.filter(session => session.status === "active").length === 0 && (
                <Card className="p-6 text-center">
                  <p className="text-nexthire-text-gray mb-3">No active sessions found.</p>
                  <Link to="/sessions">
                    <Button variant="outline" size="sm">
                      <Plus className="h-4 w-4 mr-2" />
                      Create Session
        ...
        <div>
          ...
          <Card>
            ...
            <div className="space-y-4">
              {/* This would be replaced with real candidates in a complete app */}
              {[1, 2, 3, 4, 5].map((candidate) => (
                <div 
                  key={candidate}
                  className="flex items-center p-3 rounded-lg hover:bg-nexthire-light-gray/30 transition-colors cursor-pointer"
                >
                  <div className="w-10 h-10 rounded-full bg-nexthire-light-gray flex items-center justify-center mr-3">
                    <User className="h-5 w-5 text-nexthire-text-gray" />
                  </div>
                  <div className="flex-1">
                    <h4 className="font-medium text-white">Sarah Johnson</h4>
                    <p className="text-nexthire-text-gray text-sm">Frontend Developer</p>
                  </div>
      ...
      <div className="mt-8">
        ...
        <Card className="h-64 flex items-center justify-center">
          <div className="text-center">
            <BarChart2 className="h-10 w-10 text-nexthire-purple mx-auto mb-4" />
            <p className="text-nexthire-text-gray mb-3">Analytics dashboard will be displayed here</p>
            <Link to="/analytics">
              <Button variant="outline" size="sm">
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-8">
        ...
        <p className="text-nexthire-text-gray">Manage your applications and upcoming interviews.</p>
      </div>
      
      {/* Action Cards */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card className="relative overflow-hidden border border-nexthire-light-gray/20">
          <div className="absolute top-0 right-0 w-24 h-24 -mt-10 -mr-10 bg-nexthire-purple/10 rounded-full"></div>
          <div className="absolute top-0 right-0 w-16 h-16 -mt-4 -mr-4 bg-nexthire-purple/20 rounded-full"></div>
          
          <div className="relative z-10">
            <div className="p-3 rounded-full bg-nexthire-purple/20 w-fit mb-4">
              <User className="h-6 w-6 text-nexthire-purple" />
            </div>
        ...
        <Card className="relative overflow-hidden border border-nexthire-light-gray/20">
          ...
          <div className="relative z-10">
            <div className="p-3 rounded-full bg-nexthire-purple/20 w-fit mb-4">
              <Mail className="h-6 w-6 text-nexthire-purple" />
            </div>
        ...
        <Card className="relative overflow-hidden border border-nexthire-light-gray/20">
          ...
          <div className="relative z-10">
            <div className="p-3 rounded-full bg-nexthire-purple/20 w-fit mb-4">
              <Briefcase className="h-6 w-6 text-nexthire-purple" />
            </div>
        ...
        <div className="lg:col-span-2">
          ...
          <Card>
            {[1, 2].map((interview) => (
              <div 
                key={interview}
                className="border-b border-nexthire-light-gray/20 last:border-b-0 py-4 first:pt-0 last:pb-0"
              >
                <div className="flex flex-col md:flex-row justify-between mb-2">
                  <div>
                    ...
                    <p className="text-nexthire-text-gray">TechCorp Inc.</p>
                  </div>
                  
                  <div className="md:text-right mt-2 md:mt-0">
                    <p className="text-nexthire-purple font-semibold">Tomorrow, 2:00 PM</p>
                    <p className="text-nexthire-text-gray text-sm">45 minutes</p>
                  </div>
                </div>
            ...
            <div className="mt-4 text-center text-nexthire-text-gray text-sm">
        ...
        <div>
          ...
          <Card>
            <div className="flex items-center justify-between mb-6">
              <div>
                <p className="text-nexthire-text-gray text-sm">Total Applications</p>
            ...
            <div className="space-y-4">
              <div className="p-3 bg-nexthire-light-gray/30 rounded-lg">
                ...
                <p className="text-nexthire-text-gray text-sm mb-1">DesignCraft Studios</p>
                <p className="text-nexthire-text-gray text-xs">Technical Interview Scheduled</p>
              </div>
              ...
              <div className="p-3 bg-nexthire-light-gray/30 rounded-lg">
                ...
                <p className="text-nexthire-text-gray text-sm mb-1">WebTech Solutions</p>
                <p className="text-nexthire-text-gray text-xs">Application Under Review</p>
              </div>
              ...
              <div className="p-3 bg-nexthire-light-gray/30 rounded-lg">
                ...
                <p className="text-nexthire-text-gray text-sm mb-1">Innovate Inc.</p>
                <p className="text-nexthire-text-gray text-xs">Not selected for interview</p>
              </div>
            </div>
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card isHoverable>
            <div className="p-3 rounded-full bg-nexthire-purple/20 w-fit mb-4">
              <Code className="h-6 w-6 text-nexthire-purple" />
            </div>
          ...
          <Card isHoverable>
            <div className="p-3 rounded-full bg-nexthire-purple/20 w-fit mb-4">
              <ServerIcon className="h-6 w-6 text-nexthire-purple" />
            </div>
          ...
          <Card isHoverable>
            <div className="p-3 rounded-full bg-nexthire-purple/20 w-fit mb-4">
              <Algorithm className="h-6 w-6 text-nexthire-purple" />
            </div>
