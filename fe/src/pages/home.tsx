    ...
    <div className="min-h-screen bg-[#121212] text-white">
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-6 animate-fade-in">
            <span className="bg-gradient-to-r from-[#B967FF] to-[#D4A5FF] bg-clip-text text-transparent">
              AI-Powered
            </span>{" "}
          ...
          <p className="text-lg sm:text-xl text-[#ABABAB] mb-8 max-w-3xl mx-auto animate-slide-in">
            Transform your recruitment process with NextHire's intelligent
            interview platform. Automate candidate evaluations, get data-driven
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12 animate-slide-in">
            <Link to="/login">
              <Button
                variant="primary"
                size="lg"
                className="hover:underline hover:underline-offset-4 cursor-pointer w-full sm:w-auto"
              >
                For Organizations
            ...
            <Link to="/login">
              <Button
                variant="outline"
                size="lg"
                className="group hover:bg-[#B967FF]/20 hover:border-transparent cursor-pointer w-full sm:w-auto"
              >
                For Candidates
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-[#B967FF] to-[#D4A5FF] bg-clip-text text-transparent">
              NextHire #1 End-to-End AI Interview Process Automation Software
            </h2>
            <p className="text-[#ABABAB] mb-6">
              Our software leverages Generative AI and Explainable AI to
              automate job descriptions, craft relevant interview questions, and
              pre-screen and shortlist candidates. This ensures you find the
              best talent for your roles while maintaining content relevance.
            </p>
            <h3 className="text-2xl font-semibold mb-4 text-white">
              Our Explainable AI Approach
            </h3>
            <p className="text-[#ABABAB]">
              At NextHire, we build Explainable AI to bring the most transparent
              and user-friendly smart hiring solution to your company. We help
              recruitment teams identify desirable candidates during the entire
          ...
          <div className="grid grid-cols-2 gap-4 h-full">
            <img
              src="/nh-1.png"
              alt="NextHire AI Analysis"
              className="rounded-xl object-cover w-full h-full max-h-80 border border-[#2F2F2F]/30"
            />
            <img
              src="/nh-2.png"
              alt="NextHire Dashboard"
              className="rounded-xl object-cover w-full h-full max-h-80 border border-[#2F2F2F]/30"
            />
          </div>
        </div>
      ...
      >
        <div className="text-center mb-16 animate-on-scroll opacity-0 translate-y-10">
          ...
          <p className="text-[#ABABAB] text-lg max-w-3xl mx-auto">
            NextHire combines AI-powered interviewing with powerful analytics to
            transform how you evaluate candidates.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-[#ABABAB]">
              AI generates tailored interview questions based on candidate
              responses, simulating real-life interview scenarios.
            </p>
          </Card>
          ...
          >
            ...
            <p className="text-[#ABABAB]">
              Provides instant, data-driven feedback to candidates, helping them
              improve and refine their answers.
            </p>
          </Card>
          ...
          >
            ...
            <p className="text-[#ABABAB]">
              Offers customizable interview settings, including question
              difficulty, role-specific queries, and time limits.
            </p>
          </Card>
          ...
          >
            ...
            <p className="text-[#ABABAB]">
              Provides recruiters with detailed performance analytics,
              highlighting candidate strengths and areas for improvement.
            </p>
          </Card>
          ...
          >
            ...
            <p className="text-[#ABABAB]">
              Accessible across devices, ensuring flexibility for both
          ...
          >
            ...
            <p className="text-[#ABABAB]">
              Smart AI chatbot serves as a virtual assistant for both recruiters
              and job candidates.
            </p>
          </Card>
        </div>
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl bg-[#1E1E1E] rounded-3xl overflow-hidden">
        <div className="text-center mb-16 animate-on-scroll opacity-0 translate-y-10">
          ...
          <p className="text-[#ABABAB] text-lg max-w-3xl mx-auto">
            A simplified, efficient process that saves time and improves
            candidate selection.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center animate-on-scroll opacity-0 translate-y-10">
            ...
            <p className="text-[#ABABAB] px-4">
              Set up interviews, define job roles, skills required, and
              assessment criteria.
            </p>
          </div>
          ...
          <div className="text-center animate-on-scroll opacity-0 translate-y-10">
            ...
            <p className="text-[#ABABAB] px-4">
              Candidates complete automated interviews and assessments at
              scheduled times.
            </p>
          </div>
          ...
          <div className="text-center animate-on-scroll opacity-0 translate-y-10">
            ...
            <p className="text-[#ABABAB] px-4">
              Get AI-generated insights and recommendations to make informed
              hiring decisions.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#1E1E1E] to-[#121212] border border-[#2F2F2F]/20 rounded-3xl p-8 md:p-12 shadow-xl animate-on-scroll opacity-0 translate-y-10">
          <div className="text-center mb-8">
            ...
            <p className="text-[#ABABAB] text-lg max-w-3xl mx-auto mb-8">
              Join hundreds of companies using NextHire to find the best talent
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                >
                  <path
                    d="M7 7L16 20.5L7 34H14L23 20.5L14 7H7Z"
                    fill="#B967FF"
                  />
                  <path
                    d="M26 7L35 20.5L26 34H33L42 20.5L33 7H26Z"
                    fill="#B967FF"
                  />
                </svg>
              ...
              <p className="text-[#ABABAB] mb-4">
                Transform your recruitment process with AI-powered interview
                automation.
              </p>
